...
func (app *Application) Get(route string, middleware types.Middleware) IApplication {
	app.router.Route(types.GET, route, middleware)
	return app
}

func (app *Application) Post(route string, middleware types.Middleware) IApplication {
	app.router.Route(types.POST, route, middleware)
	return app
}

func (app *Application) Put(route string, middleware types.Middleware) IApplication {
	app.router.Route(types.PUT, route, middleware)
	return app
}

func (app *Application) Delete(route string, middleware types.Middleware) IApplication {
